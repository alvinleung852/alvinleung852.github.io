...
introRegOState.prototype = {
    create: function(){
        ...
        var backgroundImg2 = game.add.sprite(-200, 0, 'intro_RegO3');
        backgroundImg2.scale.setTo(0.75, 0.75);
        // backgroundImg2.anchor.setTo(0.5, 0.5);
        backgroundImg2.alpha = 0;
        
        animationGroup.add(backgroundImg);
        animationGroup.add(backgroundImg2);
        
        game.add.tween(backgroundImg).to({alpha:0}, 250, 'Linear', true, 0);
        game.add.tween(backgroundImg2).to({alpha:1}, 250, 'Linear', true, 0);
        ...
        spriteRegO = game.add.sprite(-11, 99.5, 'regO_pose2');
        spriteRegO.scale.x *= .75;
        spriteRegO.scale.y *= .75;
        // spriteRegO = game.add.sprite('regO_pose2', 0);
        spriteRegO.x = -15;
        spriteRegO.y = 79;
        spriteRegO.animations.add('idle');
        spriteRegO.animations.play('idle', 24, true);
        
        var tweenRegO = game.add.tween(spriteRegO);
        var tweenRegO2 = game.add.tween(spriteRegO.scale);
        tweenRegO.to({x:-11, y: -50}, 1000, 'Cubic', true, 0);
        tweenRegO2.to({x:1, y: 1}, 1000, 'Cubic', true, 0);
        
        var posTitle = game.add.sprite(600, 400, 'intro_RegO');
        posTitle.anchor.setTo(0.5, 0.5);
        posTitle.scale.setTo(1, 1);
        
        var tweenTitle = game.add.tween(posTitle.scale);
        tweenTitle.to({x: 0.4, y: 0.4}, 250, 'Linear', true, 0);
        // tweenRegO2.chain(tweenTitle);
        
        var tweenTitle2 = game.add.tween(posTitle);
        tweenTitle2.to({x: 590}, 5000, 'Linear', true, 0);
        
        var posQuote = game.add.sprite(-1000, 500, 'intro_RegO2');
        posQuote.scale.setTo(0.5, 0.5);
        
        var tweenQuote = game.add.tween(posQuote);
        tweenQuote.to({x: 50}, 250, 'Linear', true, 1000);
        
        tweenTitle.chain(tweenQuote);
        
        var tweenQuote2 = game.add.tween(posQuote);
        tweenQuote2.to({x: 60}, 5000, 'Linear', false, 0);
        tweenQuote.chain(tweenQuote2);
        
        tweenQuote2.onComplete.add(this.toDesk, this);
        
        animationGroup.add(spriteRegO);
        animationGroup.add(posTitle);
        animationGroup.add(posQuote);
