...
var content = [
    "Make sure counterfoil is visible and give the ballot to the elector.", 
    "Make sure your initials are on the back.",
    "Fold it once toward the left to hide the circles.",
    "Fold it a second time toward the left.",
    "Make sure counterfoil is visible and give the ballot to the elector.",
    ""
    ];
...
IssueState.prototype = {
    create: function(){
        ...
        deskLabel = game.add.text(0 + textPadding, 0 + textPadding, "Issue a ballot", {font:'50px VT323', fill:'#ffffff'});
